...
def set_args():
    parser = argparse.ArgumentParser(
        description='Convert trained embeddings to desired output format and output to specified directory.\n\n'
                    'Example usage:\n'
    ...
    parser.add_argument("--delim",
                        metavar='delim',
                        default=",",
                        help="Delimiter to use for the output CSV")
    ...
    parser.add_argument("--overwrite",
                        action='store_true',
                        default=False,
                        help="If enabled, the output directory will be overwritten")
