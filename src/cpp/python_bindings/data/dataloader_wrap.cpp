...
//        .def_readwrite("batch_iterator", &DataLoader::batch_iterator_) # TODO Iterator needs bindings
            ...
            .def(py::init([](shared_ptr<GraphModelStorage> graph_storage,
            ...
            .def(py::init([](shared_ptr<GraphModelStorage> graph_storage,
                             std::string learning_task,
                             int batch_size,
                             shared_ptr<NegativeSampler> neg_sampler,
                             shared_ptr<NeighborSampler> nbr_sampler,
                             bool train) {
                 ...
                 py::arg("neg_sampler") = nullptr,
                 py::arg("nbr_sampler") = nullptr,
                 py::arg("train") = false)

            .def(py::init([](torch::optional<torch::Tensor> edges,
                             std::string learning_task,
                             torch::optional<torch::Tensor> nodes,
                             torch::optional<torch::Tensor> node_features,
                             torch::optional<torch::Tensor> node_embeddings,
                             torch::optional<torch::Tensor> node_optimizer_state,
                             torch::optional<torch::Tensor> node_labels,
                             torch::optional<torch::Tensor> train_edges,
                             int batch_size,
                             shared_ptr<NegativeSampler> neg_sampler,
                             shared_ptr<NeighborSampler> nbr_sampler,
                             std::vector<torch::Tensor> filter_edges,
                             bool train) {
                 ...
                 py::arg("learning_task"),
                 py::arg("nodes") = nullptr,
                 py::arg("node_features") = nullptr,
                 py::arg("node_embeddings") = nullptr,
                 py::arg("node_optim_state") = nullptr,
                 py::arg("node_labels") = nullptr,
                 py::arg("train_edges") = nullptr,
                 py::arg("batch_size") = 1000,
                 py::arg("neg_sampler") = nullptr,
                 py::arg("nbr_sampler") = nullptr,
                 py::arg("filter_edges") = std::vector<torch::Tensor>(),
                 py::arg("train") = false)
            ...
            .def("getBatch", &DataLoader::getBatch, py::arg("device") = py::none(), py::arg("perform_map") = true, py::return_value_policy::reference)
            .def("edgeSample", &DataLoader::edgeSample, py::arg("batch"))
            .def("nodeSample", &DataLoader::nodeSample, py::arg("batch"))
