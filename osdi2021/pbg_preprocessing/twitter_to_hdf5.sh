...
CMD="python osdi2021/pbg_preprocessing/parquet_to_hdf5.py --edge_dir_in "$BASE_DIR/train" --ent_part_count $NUM_PART --entity_dir "$BASE_DIR/entities" --relation_dir "$BASE_DIR/relations" --edge_dir_out "$BASE_DIR/twitter_train" --output_path "$BASE_DIR/twitter_metadata""
$CMD
