...
if __name__ == "__main__":
    ...
    # [performance_options]
    p.add_argument("--prefetch_neighbor_sampler", type=str2bool, default=True)
    p.add_argument("--use_uva", type=str2bool, default=False)
    p.add_argument("--use_alternate_streams", type=str2bool, default=True)
    p.add_argument("--use_prefetch_thread", type=str2bool, default=True)
    p.add_argument("--pin_prefetcher", type=str2bool, default=True)
